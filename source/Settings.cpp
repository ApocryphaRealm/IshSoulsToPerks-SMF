...
namespace settings
{
	...
	namespace
	{
		...
		constexpr const char* kPerksSection = "Perks";
		...
		void CaptureDefaults()
		{
			...
			defaults.dragonSoulsPerPerkPoint = perks::dragonSoulsPerPerkPoint;
		}
		...
		void ReadFromCollection()
		{
...

			{
				...
				dragonSoulsPerPerkPoint = Read<float>(c, "fDragonSoulsPerPerkPoint:Perks", dragonSoulsPerPerkPoint);
			}
		}
	}
	...
	void Init(const std::string& a_iniFileName)
	{
		...
		{
			using namespace perks;
			add("fDragonSoulsPerPerkPoint:Perks", dragonSoulsPerPerkPoint);
		}
	...
	bool Save()
	{
		...
		ok &= WriteFloat(kPerksSection, "fDragonSoulsPerPerkPoint", perks::dragonSoulsPerPerkPoint);
	...
	void RestoreDefaults()
	{
		...
		perks::dragonSoulsPerPerkPoint = defaults.dragonSoulsPerPerkPoint;
	}
